...
module.exports = async (client) => {
  ...
  app.get("/invite", function (req, res) {
    res.redirect(
      `https://discord.com/oauth2/authorize?client_id=${clientID}&redirect_uri=${domain}/thanks&response_type=code&scope=bot&permissions=490073207`
    );
  });
 ...
 */
    ...
    if (Object.prototype.hasOwnProperty.call(data, "send")) {
      ...
      if (data.messageID) {
        try {
          const emojimessage = await channelValid.messages.fetch(
            data.messageID
          );
