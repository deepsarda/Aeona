...
((e, t, n) => {
  ...
  function p(e) {
    ...
    switch (
      ((u = a * (1 - s)),
      (c = a * (1 - (o = 6 * f - (i = Math.floor(6 * f))) * s)),
      (l = a * (1 - (1 - o) * s)),
      (i = i || 0),
      (c = c || 0),
      (l = l || 0),
  ...
  function E(t) {
    ...
    return (
      t === e
        ? ((n = e.pageXOffset || r.scrollLeft),
          (i = e.pageYOffset || r.scrollTop))
        : ((n = (o = t.getBoundingClientRect()).left), (i = o.top)),
      [n, i]
    );
  }
  function P(t) {
  ...
  function X(e, n, r) {
    return (
      (e = t.createElement(e)), n && n.appendChild(e), r && (e.className = r), e
    );
  }
  function L(e) {
    return Math.round(e);
  ...
  ((e) => {
    (e[i] = (e) => {
      if (x(e)) {
        ...
        if ((4 !== t && 7 !== t) || "#" !== e[0]) {
          ...
          return 4 === t
            ? [O(e[1] + e[1], 16), O(e[2] + e[2], 16), O(e[3] + e[3], 16), 1]
            : [O(e[1] + e[2], 16), O(e[3] + e[4], 16), O(e[5] + e[6], 16), 1];
        return [0, 0, 0, 1];
      }
      return (
        "#" +
        ("000000" + Y(+e[2] | (+e[1] << 8) | (+e[0] << 16), 16)).slice(-6) +
        (w(e[3]) && e[3] < 1 ? Y(L(255 * e[3]) + 65536, 16).substr(-2) : "")
      );
    }),
      (e.instances = {}),
    ...
    (e.CP = function (n, O) {
      ...
      (Y.instances[n.id || n.name || Object.keys(Y.instances).length] = L),
        (n.CP = 1),
        (L.visible = !1);
      let $,
        z,
      ...
      !(function i(y, x) {
        (q = g((S = le()))),
          ...
          (z = () => {
            let n = ce();
            return (
              n && (n.removeChild(W), (L.current = null), (L.visible = !1)),
              C(F, s, ge),
              C(G, s, ve),
              C(J, s, be),
              C(t, a, he),
        ...
        function he(e) {
          ne &&
            ...
            (S = p(q)),
            (ne || re || ie) &&
              (ue(_ || ee || te ? "start" : "drag", S), ue("change", S)),
            (_ = ee = te = 0);
        }
        function pe(e) {
          S = p(q);
        ...
        function me() {
          var e;
          w((e = q)[1]) && H(Q, u, O - T / 2 - O * +e[1] + l),
            w(e[2]) && H(Q, o, X - A / 2 - X * +e[2] + l),
            w(e[0]) && H(U, o, fe - se / 2 - fe * +e[0] + l),
            w(e[3]) && H(Z, o, ae - de / 2 - ae * +e[3] + l);
          let t = p(q),
            n = p([q[0], 1, 1]);
          H(
            K,
        ...
        (L.color = (e, t, n, r) =>
          Y[y(Y[N.color]) ? N.color : i]([e, t, n, r])),
        (L.current = null),
        (L.enter = $),
        (L.exit = z),
        (L.fire = ue),
        ...
        (L.off = function (e, t) {
          ...
          if (w(I[e]))
            if (w(t)) {
              for (let n = 0, r = I[e].length; n < r; ++n)
                t === I[e][n] && I[e].splice(n, 1);
              0 === j && delete I[e];
            } else delete I[e];
          return L;
        }),
        ...
        (L.pop = () =>
          n.CP ? (delete n.CP, C(n, s, oe), z(), ue("pop", S)) : L),
        (L.self = W),
        (L.source = n),
        (L.state = N),
        (L.value = (e, t, n, r) => (
          L.set(e, t, n, r), ue("change", [e, t, n, r])
        ));
    })
  );
})(window, document);
