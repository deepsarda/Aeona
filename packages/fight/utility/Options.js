class options {
    ...
    constructor(options) {
        ...
        this.defenseSuccessRateAgainstDefense = (100 - defenseSuccessRateAgainstDefense) / 100;
        this.defenseSuccessRateAgainstMelee = (100 - defenseSuccessRateAgainstMelee) / 100;
        this.defenseSuccessRateAgainstRanged = (100 - defenseSuccessRateAgainstRanged) / 100;
