...
module.exports = class extends Command {
  ...
  async run(message, args) {
    ...
    let embed=new Discord.MessageEmbed().setTitle(`${user}'s Profile`).setThumbnail(user.getDisplayAvatar({dynamic:true})).addField("Wallet",user.money.wallet.toLocaleString()+'₪')
